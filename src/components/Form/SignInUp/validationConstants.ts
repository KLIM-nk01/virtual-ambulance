...
export const PhoneNumber = {
  ...
  pattern: {
    ...
    message: 'The Phone number is not valid. Please use valid format ( +375(29)397-51-** )',
  },
};
...
export const Birthday = {
  ...
  pattern: {
    value: /(?:0[1-9]|[12][0-9]|3[01])[-/.](?:0[1-9]|1[012])[-/.](?:19\d{2}|20[01][0-9]|2020)\b/,
